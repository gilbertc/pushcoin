...
NSString * const PushCoinLastTxnHistoryFile = @"txn_history.pcos";
//NSString * const PushCoinWebServicePath = @"https://api.minta.com/pcos/";
NSString * const PushCoinWebServicePath = @"https://api.pushcoin.com/pcos/";
