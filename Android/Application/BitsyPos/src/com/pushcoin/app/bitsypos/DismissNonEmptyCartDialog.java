...
public class DismissNonEmptyCartDialog extends DialogFragment
{
	@Override
	public Dialog onCreateDialog(Bundle savedInstanceState)
	{
		...
		builder.setMessage(R.string.confirm_dismiss_unpaid_cart)
	...
	public static void showDialog(FragmentManager fm)
	{
		...
		DialogFragment newFragment = new DismissNonEmptyCartDialog();
